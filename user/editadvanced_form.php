...
class user_editadvanced_form extends moodleform {
    ...
    public function definition() {
        ...
        }elseif (user_has_role_assignment($USER->id, 1, SYSCONTEXTID)) {
            if($rolename == 'partner'){
        ...
        if (!(user_has_role_assignment($USER->id, 9, SYSCONTEXTID))){ 
        ...
        //category of partnership
            ...
            }elseif (user_has_role_assignment($USER->id, 9, SYSCONTEXTID)) { //partner admin user creation form
